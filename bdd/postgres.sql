...
SELECT pg_catalog.setval('public.article_id_seq', 5002, false);
...
SELECT pg_catalog.setval('public.banhammer_id_seq', 2002, false);
...
SELECT pg_catalog.setval('public.conversation_id_seq', 3002, false);
...
SELECT pg_catalog.setval('public.disease_id_seq', 6002, false);
...
SELECT pg_catalog.setval('public.forum_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.group_id_seq', 7002, false);
...
SELECT pg_catalog.setval('public.privatemessage_id_seq', 4003, false);
...
SELECT pg_catalog.setval('public.reply_id_seq', 1003, false);
...
SELECT pg_catalog.setval('public.right_id_seq', 8003, false);
...
SELECT pg_catalog.setval('public.thread_id_seq', 102, false);
...
select setval('public.banhammer_id_seq', coalesce((select max(id)+1 from public.banhammer),1),false);
select setval('public.conversation_id_seq', coalesce((select max(id)+1 from public.conversation),1),false);
select setval('public.disease_id_seq', coalesce((select max(id)+1 from public.disease),1),false);
select setval('public.forum_id_seq', coalesce((select max(id)+1 from public.forum),1),false);
select setval('public.group_id_seq', coalesce((select max(id)+1 from public.group),1),false);
select setval('public.privatemessage_id_seq', coalesce((select max(id)+1 from public.privatemessage),1),false);
select setval('public.reply_id_seq', coalesce((select max(id)+1 from public.reply),1),false);
select setval('public.right_id_seq', coalesce((select max(id)+1 from public.right),1),false);
select setval('public.subscribe_id_seq', coalesce((select max(id)+1 from public.subscribe),1),false);
select setval('public.thread_id_seq', coalesce((select max(id)+1 from public.thread),1),false);
select setval('public.vote_reply_id_seq', coalesce((select max(id)+1 from public.vote_reply),1),false);
select setval('public.vote_thread_id_seq', coalesce((select max(id)+1 from public.vote_thread),1),false);